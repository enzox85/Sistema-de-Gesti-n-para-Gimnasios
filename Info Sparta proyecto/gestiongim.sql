...
INSERT INTO `cuotas` VALUES (51,136,20000.00,'2025-07-23','2025-08-23','2025-09-01','PAGADA',NULL,'Cuota generada automáticamente al registrar el socio.');
...
INSERT INTO `ejercicios` VALUES (34,'Press de banca c/ barra banco plano','safsdfs','PECHO','INTERMEDIO'),(38,'Press de banca en bco inclinado','','PECHO','INTERMEDIO');
...
INSERT INTO `ejercicios_media` VALUES (13,34,'IMAGEN','/spartanproject/uploads/ejercicios/ejer_34_68b6ce42db236.gif',1),(18,38,'IMAGEN','/spartanproject/uploads/ejercicios/ejer_68b6eb650b771.gif',1),(19,38,'VIDEO_LINK','https://www.youtube.com/watch?v=2bKcaD7lHLs&t=48s',2),(26,34,'VIDEO_LINK','https://www.youtube.com/watch?v=6RexLioSoMQ',2);
...
CREATE TABLE `planes_entrenamiento` (
  ...
  `idsocio` int(11) NOT NULL,
  `tipo_plan` enum('MASMUSCULAR','BAJARPESO','MANTENERPESO','MEJORARRESISTENCIA','PREPARACIONDEPORTE','REHABILITACION','FLEXIBILIDAD','OTRO') NOT NULL,
  ...
  `preferencias_dieteticas` varchar(50) DEFAULT NULL,
...
INSERT INTO `rutinas` VALUES (4,'pecho','','Principiante',1);
...
INSERT INTO `rutinas_dias` VALUES (4,4,'LUNES');
...
INSERT INTO `rutinas_ejercicios` VALUES (4,4,34,'4 x 12',180,1);
...
-- Dump completed on 2025-09-03 14:10:13
